...
export function RaffleCreation({ onBack, onSuccess }: RaffleCreationProps) {
  ...
  const steps = ['Basic Info', 'Email Verification', 'Deposit WLD'];
  ...
  const handleDeposit = () => {
    console.log('Processing 5 WLD deposit...');
    setDepositMade(true);
    // Here you would integrate with World ID/WLD payment system
  };
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              >
                {depositMade ? 'DEPOSIT COMPLETE ✓' : 'Deposit 5 WLD'}
              </Button>
            </div>
            ...
            <div className="bg-white rounded-lg p-6">
              <ul className="space-y-3" style={{ color: '#514444' }}>
                <li className="flex items-start">
                  ...
                  <span>To start a raffle, you will need to deposit 5 WLD.</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 rounded-full bg-gray-400 mt-2 mr-3 flex-shrink-0"></span>
                ...
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 rounded-full bg-gray-400 mt-2 mr-3 flex-shrink-0"></span>
                  <span>If the raffle doesn't have enough purchased tickets for three consecutive draws, it will be cancelled and your deposit will be returned minus 1 WLD.</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 rounded-full bg-gray-400 mt-2 mr-3 flex-shrink-0"></span>
